...
<div class="container">
    <div class="row justify-content-center align-items-center" style="height: 92vh;">
        <div class="col-12 col-md-4">
            <h1 class="display-5 font-weight-bold text-center text-pharm text-uppercase">Register <i class="fas fa-edit"></i></h1>
                ...
                <div class="card z-depth-1">
                    ...
                    <div class="card-body mb-1">
                        ...
                        <div class="md-form form-sm mb-5">
                            <i class="fas fa-user prefix text-pharm"></i>
                        ...
                        <div class="md-form form-sm mb-4">
                            <i class="fas fa-lock prefix text-pharm"></i>
                            <input type="password" name="register_password" id="register_password"
                                class="form-control form-control-sm validate" required>
                            <label for="register_password">Password</label>
                        </div>
                        <div class="md-form form-sm mb-4">
                            <i class="fas fa-envelope prefix text-pharm"></i>
                            <input type="email" name="register_email" id="register_email"
                                class="form-control form-control-sm validate" required>
                            <label for="register_email">Email</label>
                        </div>
                        <div class="md-form form-sm mb-4">
                            <i class="fas fa-user-secret prefix text-pharm"></i>
                            <input type="text" name="register_name" id="register_name"
                                class="form-control form-control-sm validate" required>
                            <label for="register_name">Display name</label>
                        </div>
                        <button type="submit" class="btn btn-block btn-pharm mb-3">Register</button>
