...
<div class="container">
    <div class="row justify-content-center align-items-center" style="height: 92vh;">
        <div class="col-12 col-md-4">
            <h1 class="display-5 font-weight-bold text-center text-pharm">LOGIN <i class="fas fa-sign-in-alt"></i></h1>
            <form method="post" action="../static/functions/auth/login.php" enctype="multipart/form-data">
                <div class="card z-depth-1">
                    ...
                    <div class="card-body mb-1">
                        ...
                        <button type="submit" class="btn btn-block btn-pharm mb-3">Login</button>
